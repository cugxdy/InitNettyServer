...
public final class PlatformDependent {
    ...
    private static final int MAX_ALLOWED_MPSC_CAPACITY = Integer.MAX_VALUE;
...
//            
//            return USE_MPSC_CHUNKED_ARRAY_QUEUE ? new SpscChunkedArrayQueue<T>(MPSC_CHUNK_SIZE, capacity)
