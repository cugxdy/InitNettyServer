 ...
 *
 *
 * For example here is an implementation which decodes a {@link String} to an {@link Integer}聽which represent
        ...
        try {
            ...
            if (acceptInboundMessage(msg)) {
                ...
                try {
                	...
                	// 调用ReferenceCountUtil.release()方法来释放被解码的msg对象。
            ...
            int size = out.size();
            // 对CodecOutputList进行遍历,循环调用ChannelHandlerContext的fireChannelRead方法
