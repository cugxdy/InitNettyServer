...
public interface ChannelHandler {
     ...
     */
	// handler被添加到channel的时候执行，这个动作就是由pipeline的添加handler方法完成的。
     ...
     */
    @Deprecated // 捕获channel生命周期中异常处理的类，该方法被移动到ChannelInboundHandler中了。
    ...
    @Retention(RetentionPolicy.RUNTIME) // 注解Sharable表明该handler可以被多个pipeline重复使用。
    @interface Sharable {
        // no value
    }
}
